...
const fetchRestaurantByCity = async (city: string | undefined, cuisine?: string, price?: PRICE) => {
...
const Search = async ({
  ...
  const restaurants = (await fetchRestaurantByCity(
    searchParams.city.toLowerCase(), searchParams.cuisine, searchParams.price
